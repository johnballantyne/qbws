 ...
 *                       Supply one of the following strings:
 *                        - "NULL" or "" (empty string) if you want the Web
 *                              connector to proceed with the update
 *                        - "W:<any text>" if you want the web connector to
 *                              to display a WARNING dialog prompting the user
 *                              to continue with the update or cancel it. The
 *                              text string after the "W:" will be displayed
 *                              in the warning dialog.
 *                        - "E:<any text>" if you want to cancel the update
 *                              and display an ERROR dialog. The text string
 *                              after "E:" will be displayed in the error
 *                              dialog. The user will have to download a new
 *                              version of the Web Connector to continue with
 *                              the update.
 *                        - "O:<version number>" to tell the user that the
 *                              server expects a newer version of QBWC than the
 *                              user currently has but also tells the user
