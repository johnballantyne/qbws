 ...
 *
 * @desc To enable web service with its version number returned back to QBWC.
 *
 ...
 *
 * @desc Verifies the username and password for the Web Connector that is
 *   trying to connect.
 *
 * @param {String} args.strUsername
 *
 * @param {String} args.strPassword
 *
 ...
 *
 * @desc This web method send the request XML to the client which should
 ...
 *
 * @param {String} args.ticket - A GUID-based ticket string to maintain the
 *   identity of the client.
 *
 * @param {String} args.hresult - An HRESULT value thrown by QuickBooks when
 *   trying to make a connection.
 *
 * @param {String} args.message - An error message corresponding to the
 *   HRESULT.
 *
 * @returns {String} Returns 'done' if no further action is required by from
 ...
 *   Possible values:
 *   - Greater than 0 - There are more requests to sends
