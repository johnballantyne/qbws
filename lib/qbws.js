 ...
 *
 * @summary Tells your web service about an error the Web Connector encountered
 *   in its attempt to connect to QuickBooks or QuickBooks POS.
 *
 * @desc **Important**: Don't retry the same operation in response to the
 ...
 *
 * @summary Lets your web service tell the Web Connector where to get the web
 *   page to display in the browser at the start of interactive mode.
 *
 * @desc Used to support interactive mode. To start interactive mode, your web
 *   service indicates to the Web Connector that it wants to start interactive
 *   mode by returning an empty string from sendRequestXML, which causes the
 *   Web Connector to invoke getLastError. Then from getLastError you return
 *   the string 'Interactive mode' to kick off the interactive session.
 *
