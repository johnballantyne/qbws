...
function buildRequest() {
    ...
    inputXMLDoc = new xmldom.DOMImplementation().createDocument(null, null, null);
    ...
    maxReturned.appendChild(inputXMLDoc.createTextNode('1'));
    customerQueryRq.appendChild(maxReturned);

    // console.log(new xmldom.XMLSerializer().serializeToString(inputXMLDoc));
...
function (args) {
    ...
    // This is a pretty weak version check and should
...
function (args) {
    ...
    if (Object.getOwnPropertyNames(hresult).length !== 0) {
